<template>
  <view class="container">
    ...
    <view class="cate-section">
      <block v-for="(menuItem, index) in menuList" :key="index">
        <view class="cate-item">
          <image :src="menuItem.img"></image>
          <text>{{ menuItem.dsc }}</text>
        </view>
      </block>
      <!-- <view class="cate-item">
...
import {setCartTabBadge} from '@/utils/app.js';
export default {
  data() {
    return {
      swiperCurrent: 0,
      ...
      goodsList: [
        ...
        },
        {
          ...
          image3:
            "http://img.zcool.cn/community/017a4e58b4eab6a801219c77084373.jpg",
          title: "潘歌针织连衣裙",
          price: 78,
          sales: 16,
        },
        {
          ...
          image3:
            "http://ikids.61kids.com.cn/upload/2018-12-29/1546070626796114.jpg",
      ...
      menuList: [
        {
          img: "https://gimg2.baidu.com/image_search/src=http%3A%2F%2Fd.ifengimg.com%2Fw2560_h1440_q70%2Fimg1.ugc.ifeng.com%2Fnewugc%2F20200718%2F10%2Fwemedia%2F9197e5996fbf14424ce3c21c747a68d18f188a8f_size289_w2560_h1440.jpg&refer=http%3A%2F%2Fd.ifengimg.com&app=2002&size=f9999,10000&q=a80&n=0&g=0n&fmt=jpeg?sec=1627461613&t=21e07830b63faa46e446a714cd399d23",
          dsc: "环球美食",
        },
        {
          img: "https://gimg2.baidu.com/image_search/src=http%3A%2F%2Fd.ifengimg.com%2Fw2560_h1440_q70%2Fimg1.ugc.ifeng.com%2Fnewugc%2F20200718%2F10%2Fwemedia%2F9197e5996fbf14424ce3c21c747a68d18f188a8f_size289_w2560_h1440.jpg&refer=http%3A%2F%2Fd.ifengimg.com&app=2002&size=f9999,10000&q=a80&n=0&g=0n&fmt=jpeg?sec=1627461613&t=21e07830b63faa46e446a714cd399d23",
