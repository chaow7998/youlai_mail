<template>
	<view v-if="visibleSync" :style="[customStyle, {
		...
		<Mask :duration="duration" :custom-style="maskCustomStyle" :maskClickAble="maskCloseAble" :z-index="uZindex - 2" :show="showDrawer && mask" @click="maskClick"/>
		<view
...
<script>
	...
	import Mask from "./u-mask/u-mask"
	import Icon from "./u-icon/u-icon"
/**
 * popup 弹窗
